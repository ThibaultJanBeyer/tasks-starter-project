...
export const save = async (body: Pick<ITask, "name" | "description" | "status">): Promise<ITask> => {
  try {
...
export const update = async (id: string, body: Pick<ITask, "name" | "description" | "status">): Promise<ITask | null> => {
  try {
